...
class TestParticipatInConversation:
    ...
    def test_participates_when_mentioned(self):
        ...
        ai_client.send.assert_called_once_with(
            text="A conversation message @botname",
            context=None
        )
    ...
    def test_continues_conversation_within_5_minutes_from_an_intervention(self):
        ...
        with freeze_time("2023-06-06T16:04:55"):
            ParticipateInConversation(cacabot=cacabot, conversation_engine=conversation_engine, participation_probability=0).do(conversation_message_2)

        with freeze_time("2023-06-06T16:09:56"):
            ParticipateInConversation(cacabot=cacabot, conversation_engine=conversation_engine, participation_probability=0).do(conversation_message_3)
